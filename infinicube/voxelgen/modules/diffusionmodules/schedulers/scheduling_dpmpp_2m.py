...
from infinicube.voxelgen.modules.diffusionmodules.schedulers.output import (
    SchedulerOutput,
)
from infinicube.voxelgen.modules.diffusionmodules.schedulers.torch_utils import (
    randn_tensor,
)
from infinicube.voxelgen.modules.diffusionmodules.schedulers.utils import (
...
class DPMSolverMultistepScheduler:
    ...
    def __init__(
        ...
        self.config.solver_order = solver_order
        self.config.prediction_type = prediction_type
        self.config.thresholding = thresholding
        self.config.dynamic_thresholding_ratio = dynamic_thresholding_ratio
        self.config.sample_max_value = sample_max_value
        self.config.algorithm_type = algorithm_type
        self.config.solver_type = solver_type
        self.config.lower_order_final = lower_order_final
        self.config.use_karras_sigmas = use_karras_sigmas
        self.config.lambda_min_clipped = lambda_min_clipped
        self.config.variance_type = variance_type
        self.config.timestep_spacing = timestep_spacing
        self.config.steps_offset = steps_offset
