...
from infinicube.voxelgen.modules.diffusionmodules.openaimodel.util import conv_nd
...
class SpatialTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.proj_in = conv_nd(
            3, in_channels, inner_dim, kernel_size=1, stride=1, padding=0
        )
        ...
        self.proj_out = zero_module(
            conv_nd(3, inner_dim, in_channels, kernel_size=1, stride=1, padding=0)
        )
